...
class Polushkin_Blog_Block_Adminhtml_Category_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('category_request')->getId()) {
            return Mage::helper('blog')->__("Edit Request # %s", $this->escapeHtml(Mage::registry('category_request')->getId()));
        }
        else {

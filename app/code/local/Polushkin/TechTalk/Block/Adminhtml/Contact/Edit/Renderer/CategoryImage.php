...
class Polushkin_TechTalk_Block_Adminhtml_Contact_Edit_Renderer_CategoryImage extends Varien_Data_Form_Element_Abstract
{
    /**
     * Constructor
     *
    ...
    public function getElementHtml()
    {
        ...
        if ((string)$this->getValue()) {
            ...
            if( !preg_match("/^http\:\/\/|https\:\/\//", $url) ) {
                $url = Mage::getBaseUrl('media') . 'blog' .DS.$url;
            }
